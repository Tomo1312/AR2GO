...
import com.example.ar2go.R;

import zoominimage.animation.AnimCompat;
import zoominimage.animation.SpringInterpolator;
import zoominimage.gestures.OnScaleAndMoveGestureListener;
import zoominimage.gestures.ScaleAndMoveDetector;
import zoominimage.window.WindowManagerUtil;
